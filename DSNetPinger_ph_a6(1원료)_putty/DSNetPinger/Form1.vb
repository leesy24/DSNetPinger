...
Public Class Form1
    ...
    Public ucMC18 As New UserControl1
        ...
        Do While Not strLine Is Nothing
            ...
            If RowValue(0).ToString <> "" Then
                ...
                Else
                    ...
                    If ucMC18.Tag = RowValue(0).ToString Then ucMC18.carIPReceive(RowValue(0), RowValue(1), RowValue(2), i)
    ...
    Public Sub ControlPosition()
        ...
        lblMainTitle.Text = "1원료 WIRELESS NETWORK MONITERING SYSTEM"
    ...
    Public Sub ucMcSetup()
        ...
        grMainRight1.Controls.Add(ucMC18)
        '' grMainRight1.Controls.Add(ucMC19)

        ucMc1.Height = grMainRight1.Height / 10 ''//Position :: ucMC Count ==  ucMC + 1

        mcTopVal = ((grMainRight1.Height - (ucMc1.Height * 9)) / 10)  ''//Position Space == ucMC / ucMC + 1

        ''//position edit 2015-12-29
        ''ucMc1.Width = 580 ''grMainRight1.Width / 1.3
        ''//FORWARD
        ucMc1.Top = 15  ''12    ''Location = New Point(500, 15)
        ''//ucMc1.Left = (grMainRight1.Width - ucMc1.Width) * 0.977
        ucMc1.Left = 60 ''//(grMainRight1.Width - ucMc1.Width) * 0.544  ''0.888
        ...
        ucMC9.Left = ucMc1.Left ''ucMC7.Left ''(grMainRight1.Width - ucMachine2.Width) * 0.977
        ucMC9.Top = ucMC8.Top + ucMC8.Height + mcTopVal     ''Location = New Point(500, 15)
        ucMC9.carPosition(1)
        ucMC9.carInput("FORWARD", 1) ''//, "M101", "G101") '//machine, server, ap
        ucMC9.Tag = "ST602"
        ucMC9.Refresh()
        ...
        ucMC10.Left = grMainRight1.Width - ucMC10.Width - 60  ''ucMC7.Left ''(grMainRight1.Width - ucMachine2.Width) * 0.977
        ucMC10.Top = ucMc1.Top  ''ucMC9.Top + ucMC9.Height + mcTopVal     ''Location = New Point(500, 15)
        ...
        grMainRight2.Top = ucMC2.Top + ucMC2.Height  ''+ (ucMC3.Height / 2)
        ...
        ''//BRC611 Line
        nLine1.Width = (grMainRight2.Left - (ucMc1.Left + ucMc1.Width)) / 3   ''(cmdMCR.Left - (ucMc1.Left + ucMc1.Width)) / 2
        ...
        nLine3.Left = nLine1.Left
        nLine3.Height = nLine1.Height
        nLine3.Width = grMainRight2.Left - nLine3.Left
        ...
        nLine12.Width = ucMC12.Left - (grMainRight2.Left + grMainRight2.Width) ''nLine1.Width
        nLine12.Left = grMainRight2.Left + grMainRight2.Width   ''//(nLine1.Left + nLine1.Width) - nLine3.Width
        ...
        nLine18.Height = (nLine9.Top - nLine1.Top) + nLine11.Height      ''- nLine1.Top
        ...
        nLine19.Top = nLine10.Top '' + (ucMC9.Height / 2)
        nLine19.Left = nLine10.Left ''+ nLine1.Width
        nLine19.Height = (nLine15.Top - nLine10.Top) + nLine10.Height      ''- nLine1.Top
        ...
        'nLine20.Top = grMainRight2.Top + grMainRight2.Height  '' + (ucMC9.Height / 2)
        'nLine20.Left = grMainRight2.Left + (grMainRight2.Width / 2) ''+ nLine1.Width
        'nLine20.Height = ucMC9.Top - (grMainRight2.Top + grMainRight2.Height)      ''- nLine1.Top
        'nLine20.Width = nLine1.Height
        'nLine20.BackColor = nLine1.BackColor
        'nLine20.Visible = True

        ' ''//label text design 2015-12-29 ============================================================
        lblEtctxt1.Top = nLine6.Top + nLine6.Height
        lblEtctxt1.Left = nLine6.Left + nLine6.Width + 10
